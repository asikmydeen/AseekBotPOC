            ...
            <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        className={`w-full p-3 rounded-md transition-colors text-base ${errors.title ? 'border-red-500' : ''} ${isDarkMode
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        className={`w-full p-3 rounded-md transition-colors text-base ${errors.description ? 'border-red-500' : ''} ${isDarkMode
                                ? 'bg-gray-700 text-white placeholder-gray-400 border-gray-600'
                                : 'bg-white text-gray-900 placeholder-gray-500 border-gray-300'
                            } border focus:ring-2 focus:ring-blue-500 focus:outline-none`}
                ...
                <div className="mb-4">
                    ...
                    <textarea
                        ...
                        rows={16}
                        className={`w-full p-3 rounded-md transition-colors ${errors.content ? 'border-red-500' : ''} ${isDarkMode
                                ? 'bg-gray-700 text-white placeholder-gray-400 border-gray-600'
                                : 'bg-white text-gray-900 placeholder-gray-500 border-gray-300'
                            } border focus:ring-2 focus:ring-blue-500 focus:outline-none text-base`}
                ...
                <div className="flex justify-end space-x-4 mt-8">
                    <button
                        type="button"
                        onClick={onCancel}
                        className={`px-5 py-2.5 rounded-md transition-colors text-base font-medium ${isDarkMode
                    ...
                    <button
                        type="submit"
                        className={`px-5 py-2.5 rounded-md transition-colors flex items-center text-base font-medium ${isDarkMode
                                ? 'bg-blue-600 hover:bg-blue-700 text-white'
                                : 'bg-blue-500 hover:bg-blue-600 text-white'
