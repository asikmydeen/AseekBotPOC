...
const EnhancedFileDialogTest: React.FC = () => {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">Enhanced File Dialog Test</h1>
      ...
      <EnhancedFileDialog
        ...
        promptTitle="Test Prompt with Various Variable Types"
        requiredFileCount={1}
...
export default EnhancedFileDialogTest;
