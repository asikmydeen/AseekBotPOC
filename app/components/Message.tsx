...
import {
    ...
    getMultimediaButtonClass,
    getActionButtonsContainerClass,
    getReactionButtonClass,
    getPinButtonClass,
    getFileListContainerClass,
    getFileItemHoverStyle,
    getFileItemClass,
    getFileContentContainerClass,
    getFileNameClass,
    getFileSizeClass,
    getFileActionsContainerClass,
    getFileActionButtonHoverStyle,
    getFileActionIconClass,
    getShowMoreFilesClass,
    getPaperclipIconClass,
    getAttachmentCountClass,
    getMoreFilesIndicatorClass,
    getReportContainerClass,
    getReportTitleClass,
    getReportButtonContainerClass,
    getReportToggleButtonClass,
    getReportDownloadButtonClass,
    getCitationButtonClass,
    getCitationPanelClass,
    getCitationTitleClass,
    getCitationListClass,
    getTicketInfoClass,
    getTicketTitleClass,
